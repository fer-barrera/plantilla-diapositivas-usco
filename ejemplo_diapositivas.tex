...
\date[\today]{\today}
\author[Nombre Apellido]{Nombre completo\inst{1}, \textit{Eng. Ms.C, Ph.D}}
\email{x@usco.edu.co}
...
\begin{frame}[label=simmonshall]{Text blocks}
   ...
   \begin{brownblock}{brownblock}
    ...
    \begin{darkredblock}{darkredblock}
        This is a proof idea.
    \end{darkredblock}
    
    \begin{lightredblock}{lightredblock}
        This is a proof idea.
    \end{lightredblock}
 ...
 \begin{frame}[label=simmonshall]{Text blocks}    
    ...
    \begin{rededgeblock_sm}{rededgeblock}
        This is a proof idea.
    \end{rededgeblock_sm}
